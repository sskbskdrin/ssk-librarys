...
public class DateTimePicker extends LinearLayout implements PickerView.onSelectListener {
	...
	public long getSelectTime() {
		...
		calendar.clear();
		calendar.set(mPickerYearView.getCurrentValue(), mPickerMonthView.getCurrentValue() - 1, mPickerDayView
				.getCurrentValue(), mPickerHourView.getCurrentValue(), mPickerMinuteView.getCurrentValue());
	...
	public void onTicker(PickerView view, int oldPosition, int newPosition) {
		if (view == mPickerYearView) {
			...
			updateHour(mPickerYearView.getCurrentValue(), mPickerMonthView.getCurrentValue(), mPickerDayView
					.getCurrentValue());
		} else if (view == mPickerHourView) {
			updateMinute(mPickerYearView.getCurrentValue(), mPickerMonthView.getCurrentValue(), mPickerDayView
					.getCurrentValue(), mPickerHourView.getCurrentValue());
