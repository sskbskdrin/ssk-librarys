 ...
 * @author keayuan
 */
public interface INewRequest<V> {
     ...
     * @return IRequest
     */
    INewRequest<V> addHeader(String key, String value);
     ...
     * @return IRequest
     */
    INewRequest<V> headers(IMap<String, String> iMap);
     ...
     * @return IRequest
     */
    INewRequest<V> addParams(String key, Object value);
     ...
     * @return IRequest
     */
    INewRequest<V> params(IMap<String, Object> iMap);
     ...
     * @return IRequest
     */
    INewRequest<V> connectedTimeout(long time);
     ...
     * @return IRequest
     */
    INewRequest<V> readTimeout(long time);
     ...
     * @return IRequest
     */
    INewRequest<V> pre(ICallback<String> request);
     ...
     * @return IRequest
     */
    INewRequest<V> parseResponse(IParseResponse<V> parse);
     ...
     * @return IRequest
     */
    INewRequest<V> progress(ICallback<Float> progress);
     ...
     * @return IRequest
     */
    INewRequest<V> success(ICallback2<V, IParseResult<V>> success);
     ...
     * @return IRequest
     */
    INewRequest<V> successIO(ICallback2<V, IParseResult<V>> success);
     ...
     * @return IRequest
     */
    INewRequest<V> error(ICallback<Error> error);
     ...
     * @return IRequest
     */
    INewRequest<V> complete(ICallback<String> complete);
